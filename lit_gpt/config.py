...
#######################
gpt2 = [
    # https://huggingface.co/openai-gpt/blob/main/config.json   ]
    dict(
        org="openai",
        name="gpt2-124m",
        block_size=1024,
        padded_vocab_size=50304,  # GPT-2 vocab_size of 50257, padded up to nearest multiple of 64 for efficiency
        n_layer=12,
        n_head=12,
        n_embd=768,
        parallel_residual=False,
